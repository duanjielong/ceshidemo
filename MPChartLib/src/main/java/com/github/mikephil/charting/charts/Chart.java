...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends
     ...
     * recalculations. It is crucial that this method is called everytime data is changed
     ...
     * be highlighted via drag or programmatically. Default: true
     */
     ...
     * set for JPEG only. 0 == maximum compression, 100 = low compression (high quality). NOTE:
    ...
    public boolean saveToGallery(String fileName, String subFolderPath, String fileDescription,
        ...
        return getContext().getContentResolver().insert(Images.Media.EXTERNAL_CONTENT_URI, values)
            != null;
    }
