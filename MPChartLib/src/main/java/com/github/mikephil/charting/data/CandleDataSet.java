 ...
 */
public class CandleDataSet extends LineScatterCandleRadarDataSet<CandleEntry> implements
    ICandleDataSet {
    ...
    /**
     * Sets the space that is left out on the left and right side of each candle, default 0.1f
     * (10%), max 0.45f, min 0f
     */
