...
public class Legend extends ComponentBase {
    ...
    /**
     * the space between the legend entries on a vertical axis, default 2f private float
     * mYEntrySpace = 2f; /** the space between the form and the actual label/text
     */
    ...
    /**
     * Sets a custom legend's entries array. * A null label will start a group. This will disable
     * the feature that automatically calculates the legend entries from the datasets. Call
    ...
    /**
     * This property is deprecated - Use `horizontalAlignment`, `verticalAlignment`, `orientation`,
    ...
    /**
     * The maximum relative size out of the whole chart view. / If the legend is to the right/left
     * of the chart, then this affects the width of the legend. / If the legend is to the top/bottom
     * of the chart, then this affects the height of the legend. / If the legend is the center of
     * the piechart, then this defines the size of the rectangular bounds out of the size of the
     * "hole". / default: 0.95f (95%)
     */
     ...
     * The maximum relative size out of the whole chart view. / If the legend is to the right/left
     * of the chart, then this affects the width of the legend. / If the legend is to the top/bottom
     * of the chart, then this affects the height of the legend. / default: 0.95f (95%)
     */
