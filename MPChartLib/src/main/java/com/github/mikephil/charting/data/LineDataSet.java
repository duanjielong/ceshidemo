...
public class LineDataSet extends LineRadarDataSet<Entry> implements ILineDataSet {
    ...
    /**
     * Sets the intensity for cubic lines (if enabled). Max = 1f = very cubic, Min = 0.05f = low
     * cubic effect, Default: 0.2f
     */
     ...
     * array. Make sure that the colors are already prepared (by calling
