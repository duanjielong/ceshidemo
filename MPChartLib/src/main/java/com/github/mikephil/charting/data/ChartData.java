...
public abstract class ChartData<T extends IDataSet<? extends Entry>> {
    ...
    public Entry getEntryForHighlight(Highlight highlight) {
        if (highlight.getDataSetIndex() >= mDataSets.size()) {
            ...
            return mDataSets.get(highlight.getDataSetIndex())
                .getEntryForXValue(highlight.getX(), highlight.getY());
        }
    }
    ...
    /**
     * Adds an Entry to the DataSet at the specified index. Entries are added to the end of the
     * list.
     */
    ...
    /**
     * Returns the DataSet object with the maximum number of entries or null if there are no
     * DataSets.
     */
