 ...
 */
public class ChartHighlighter<T extends BarLineScatterCandleBubbleDataProvider> implements
    IHighlighter {
    ...
    protected Highlight getHighlightForX(float xVal, float x, float y) {
        ...
        YAxis.AxisDependency axis = leftAxisMinDist < rightAxisMinDist ? YAxis.AxisDependency.LEFT
            : YAxis.AxisDependency.RIGHT;

        Highlight detail = getClosestHighlightByPixel(closestValues, x, y, axis,
     ...
     */
    protected float getMinimumDistance(List<Highlight> closestValues, float pos,
