...
public interface IDataSet<T extends Entry> {
    ...
    /**
     * set this to true to draw y-values on the chart NOTE (for bar and linechart): if
    ...
    /**
     * Returns true if this DataSet is visible inside the chart, or false if it is currently
     * hidden.
     */
    boolean isVisible();
