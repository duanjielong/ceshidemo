...
public class ColorTemplate {
    ...
    /**
     * THE COLOR THEMES ARE PREDEFINED (predefined color integer arrays), FEEL FREE TO CREATE YOUR
     * OWN WITH AS MANY DIFFERENT COLORS AS YOU WANT
     */
    ...
    public static final int[] COLORFUL_COLORS = {
        Color.rgb(193, 37, 82), Color.rgb(255, 144, 0), Color.rgb(245, 199, 0),
