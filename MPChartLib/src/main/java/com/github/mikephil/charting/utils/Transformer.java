...
public class Transformer {
     ...
     */
    public float[] generateTransformedValuesBubble(IBubbleDataSet data, float phaseY, int from,
        int to) {
    ...
    /**
     * transform a path with all the given matrices VERY IMPORTANT: keep order to
     * value-touch-offset
     */
