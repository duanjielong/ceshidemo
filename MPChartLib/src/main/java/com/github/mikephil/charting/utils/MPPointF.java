...
public class MPPointF extends ObjectPool.Poolable {
    ...
    /**
     * Set the point's coordinates from the data stored in the specified parcel. To write a point to
     * a parcel, call writeToParcel(). Provided to support older Android devices.
     *
