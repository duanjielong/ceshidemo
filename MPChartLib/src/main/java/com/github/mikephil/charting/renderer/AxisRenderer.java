...
public abstract class AxisRenderer extends Renderer {
    ...
    /**
     * Returns the Paint object that is used for drawing the axis-line that goes alongside the
     * axis.
     */
    ...
    public void computeAxis(float min, float max, boolean inverted) {
        ...
        if (mViewPortHandler != null && mViewPortHandler.contentWidth() > 10 && !mViewPortHandler
            .isFullyZoomedOutY()) {
    ...
    /**
     * Sets up the axis values. Computes the desired number of labels between the two given
     * extremes.
     */
    protected void computeAxisValues(float min, float max) {
        ...
        // Normalize interval
        double intervalMagnitude = Utils
            .roundToNextSignificant(Math.pow(10, (int) Math.log10(interval)));
        ...
        if (mAxis.isForceLabelsEnabled()) {
            ...
            double last =
                interval == 0.0 ? 0.0 : Utils.nextUp(Math.floor(yMax / interval) * interval);
