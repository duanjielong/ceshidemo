...
public class BarData extends BarLineScatterCandleBubbleData<IBarDataSet> {
     ...
     * bars and groups as specified by the parameters. Do not forget to call notifyDataSetChanged()
     * on your BarChart object after calling this method.
     *
    ...
    /**
     * In case of grouped bars, this method returns the space an individual group of bar needs on
     * the x-axis.
     */
