...
public class CombinedChartRenderer extends DataRenderer {
            ...
            switch (order) {
                ...
                case CANDLE:
                    if (chart.getCandleData() != null) {
                        mRenderers
                            .add(new CandleStickChartRenderer(chart, mAnimator, mViewPortHandler));
                    }
                    break;
                case SCATTER:
                    if (chart.getScatterData() != null) {
                        mRenderers
                            .add(new ScatterChartRenderer(chart, mAnimator, mViewPortHandler));
                    }
                    break;
            }
        }
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        for (DataRenderer renderer : mRenderers) {
            ...
            renderer.drawHighlighted(c,
                mHighlightBuffer.toArray(new Highlight[mHighlightBuffer.size()]));
        }
    }
