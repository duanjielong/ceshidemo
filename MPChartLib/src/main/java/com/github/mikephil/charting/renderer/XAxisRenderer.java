    ...
    protected void drawLabels(Canvas c, float pos, MPPointF anchor) {
        ...
        for (int i = 0; i < positions.length; i += 2) {
            ...
            if (mViewPortHandler.isInBoundsX(x)) {
                ...
                String label = mXAxis.getValueFormatter()
                    .getFormattedValue(mXAxis.mEntries[i / 2], mXAxis);
    ...
    public void renderLimitLineLabel(Canvas c, LimitLine limitLine, float[] position,
        ...
        if (label != null && !label.equals("")) {
            ...
            if (labelPosition == LimitLine.LimitLabelPosition.RIGHT_TOP) {
                ...
                mLimitLinePaint.setTextAlign(Align.LEFT);
                c.drawText(label, position[0] + xOffset, mViewPortHandler.contentBottom() - yOffset,
                    mLimitLinePaint);
