...
public class BarChart extends BarLineChartBase<BarData> implements BarDataProvider {
    ...
    protected void calcMinMax() {
        ...
        mAxisRight
            .calculate(mData.getYMin(YAxis.AxisDependency.RIGHT), mData.getYMax(YAxis.AxisDependency
                .RIGHT));
    }
     ...
     * highlight the whole bar, even if only a single stack entry was tapped. Default: false
     */
