...
public abstract class PieRadarChartBase<T extends ChartData<? extends IDataSet<? extends Entry>>>
    ...
    /**
     * gets the raw version of the current rotation angle of the pie chart the returned value could
     * be any value, negative or positive, outside of the 360 degrees. this is used when working
     * with rotation direction, mainly by gestures and animations.
     */
    ...
    /**
     * gets a normalized version of the current rotation angle of the pie chart, which will always
     * be between 0.0 < 360.0
     */
