...
public abstract class BaseDataSet<T extends Entry> implements IDataSet<T> {
     ...
     * number of Entries the DataSet represents is higher than the size of the colors array. If you
     * are using colors from the resources, make sure that the colors are already prepared (by
     * calling getResources().getColor(...)) before adding them to the DataSet.
     */
