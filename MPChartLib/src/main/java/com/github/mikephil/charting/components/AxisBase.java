...
public abstract class AxisBase extends ComponentBase {
    ...
    /**
     * Sets the color of the grid lines for this axis (the horizontal lines coming from each
     * label).
     */
    ...
    public IAxisValueFormatter getValueFormatter() {
        ...
        if (mAxisValueFormatter == null ||
            (mAxisValueFormatter instanceof DefaultAxisValueFormatter &&
                ((DefaultAxisValueFormatter) mAxisValueFormatter).getDecimalDigits()
                    != mDecimals)) {
    ...
    /**
     * Enables the grid line to be drawn in dashed mode, e.g. like this "- - - - - -". THIS ONLY
     * WORKS IF HARDWARE-ACCELERATION IS TURNED OFF. Keep in mind that hardware acceleration boosts
     * performance.
     *
    ...
    /**
     * Enables the axis line to be drawn in dashed mode, e.g. like this "- - - - - -". THIS ONLY
     * WORKS IF HARDWARE-ACCELERATION IS TURNED OFF. Keep in mind that hardware acceleration boosts
     * performance.
     *
     * @param lineLength the length of the line pieces
