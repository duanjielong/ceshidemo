 ...
 */
public class BarLineChartTouchListener extends
    ChartTouchListener<BarLineChartBase<? extends BarLineScatterCandleBubbleData<?
    ...
    public BarLineChartTouchListener(
        BarLineChartBase<? extends BarLineScatterCandleBubbleData<? extends
                ...
                if (Math.abs(velocityX) > Utils.getMinimumFlingVelocity() ||
                    ...
                    if (mTouchMode == DRAG && mChart.isDragDecelerationEnabled()) {
                        ...
                        Utils.postInvalidateOnAnimation(
                            mChart); // This causes computeScroll to fire, recommended for this by
                        // Google
                    }
                }
    ...
    /**
     * Sets the minimum distance that will be interpreted as a "drag" by the chart in dp. Default:
     * 3dp
     */
    ...
    public boolean onDoubleTap(MotionEvent e) {
        ...
        if (mChart.isDoubleTapToZoomEnabled() && mChart.getData().getEntryCount() > 0) {
            ...
            mChart.zoom(mChart.isScaleXEnabled() ? 1.4f : 1f, mChart.isScaleYEnabled() ? 1.4f : 1f,
                trans.x, trans.y);
    ...
    public void computeScroll() {
        ...
        MotionEvent event = MotionEvent
            .obtain(currentTime, currentTime, MotionEvent.ACTION_MOVE, mDecelerationCurrentPoint.x,
